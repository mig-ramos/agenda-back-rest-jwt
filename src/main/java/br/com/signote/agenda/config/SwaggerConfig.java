...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("br.com.signote.agenda.resources")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API do TCC Spring Boot", "Esta API é utilizada na Agenda de Especialistas Online",
				"Versão 1.0", null, new Contact("Miguel Arcanjo", null, "mig.ramos10@gmail.com"), null, null,
