...
SimpleDateFormat sdf1= new SimpleDateFormat("dd/MM/yyyy HH:mm");
		...
		Medico med1 = new Medico(null, "Médico da Silva", "m.ephemeris@gmail.com", pe.encode("123"),"123456",sdf1.parse("04/05/2021 10:45"), true, 123456, sdf2.parse("14/05/2008"));
		
		Medico med2 = new Medico(null, "Médico Siderbit", "siderbit@gmail.com", pe.encode("123"),"789123",sdf1.parse("14/10/2021 12:45"), true, 435465, sdf2.parse("14/05/2010"));
